...
namespace Roblox.Libraries.TwitterApi
{
    ...
    public class TwitterApi
    {
        ...
        public async Task<TwitterUserObject> GetUserByScreenName(string screenName)
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Get, "https://api.twitter.com/2/users/by?usernames=" + encodedName + "&user.fields=created_at,public_metrics,description");
            request.Headers.Add("Authorization", "Bearer AAAAAAAAAAAAAAAAAAAAAL7XoQEAAAAALxyrpWDyYOLeCQPXVNdBFfz0bdM%3DqJ86eb5JqCSojZerKHY5MInvEc5wRk5j6i04I1EP5ISjVQMuO5");
