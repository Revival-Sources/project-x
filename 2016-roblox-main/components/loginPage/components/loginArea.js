...
const loginThroughCookieRequired = getFlag('requireLoginThroughCookie', false);
...
const LoginArea = props => {
    ...
    const onLoginClick = e => {
        ...
        if (loginThroughCookieRequired) {
            // If login through cookie is required, follow the cookie login flow.
    ...
    return (
        <div className='row'>
            ...
            <div className='col-12'>
                <h1 className={s.header}>Login to Project X</h1>
